...
| 디자인 트랙 확인 대기 | #189로 열한 건을 모아 올렸다. 그중 둘은 2026-09-13 피그마 대조에서 풀렸다 — 인체도 프레임이 없는 이유(IA가 `제작 예정`으로 적는다)와 `1r-2-C`·`1r-1-S` 중 어느 쪽(IA가 `1r-1-S로 대체`로 적는다). 남은 것은 아홉이다. 막히던 셋은 2026-09-14에 답을 받아 풀렸다(#235) — 1q-1 편집은 찾은 줄만 고치는 지금 방식대로 두고(#184 닫음), 하루에 진료가 둘이면 기록만 쌓이며(#179), 저장한 기록은 고치지 않고 기록 상세를 확인 전용으로 둔다. 남은 여섯은 대조 때부터 남아 있던 것이고 코드는 괄호 안대로 둔다 — 기록 상세 타임라인 차례, `1r-4` 상단 왼쪽 ×·‹, 1b의 "잘 모르겠어요 · 없어요" 보조 버튼, 문답의 퀵 리플라이(IA에만 있고 시안에도 코드에도 없다), 카드 확정 시 캘린더 자동 등록의 주체(IA가 백엔드로 적는다) |
